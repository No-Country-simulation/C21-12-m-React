...
const EncargadoSelect = forwardRef(({ value, onChange, encargados, error, helperText }, ref) => {
	return (
		<TextField
			label="Encargado"
			id="encargado-select"
			...
			fullWidth
			sx={{ mt: 2 }}
			ref={ref} // Agrega la referencia aquí
		>
...
// Definir displayName para ESLint
EncargadoSelect.displayName = "EncargadoSelect";
