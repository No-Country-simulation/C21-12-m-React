...
-- AddForeignKey
ALTER TABLE "clientes" ADD CONSTRAINT "clientes_encargadoId_fkey" FOREIGN KEY ("encargadoId") REFERENCES "encargados"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "proyectos" ADD CONSTRAINT "proyectos_responsableId_fkey" FOREIGN KEY ("responsableId") REFERENCES "encargados"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "actividades" ADD CONSTRAINT "actividades_responsableId_fkey" FOREIGN KEY ("responsableId") REFERENCES "encargados"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
